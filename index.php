...
// SIGNED-UP USER 
$signed_user = new SignedUser('Via Gallia, 95, 00183 Roma', 15, 'Carlo', 'Rossi', 'carlRoss@gmail.com');
// var_dump($signed_user);

$signed_user->addProd($dog_treats);
$signed_user->addProd($dog_toy);
$signed_user->addProd($dog_bed);

$base_user->addProd($dog_treats);

// var_dump($signed_user->chosenProd);
// var_dump($base_user->chosenProd);
